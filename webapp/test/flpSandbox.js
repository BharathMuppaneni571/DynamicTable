		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Dynamic Table",
									"targetURL": "#comtestingdynamictable-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comtestingdynamictable-display": {
								"semanticObject": "comtestingdynamictable",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.testing.dynamictable",
									"url": sap.ui.require.toUrl("com/testing/dynamictable")
								}
							}
						}
					}
