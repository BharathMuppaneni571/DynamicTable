		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#combharathdynamicritchtexteditor-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"combharathdynamicritchtexteditor-display": {
								"semanticObject": "combharathdynamicritchtexteditor",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.bharath.dynamicritchtexteditor",
									"url": sap.ui.require.toUrl("com/bharath/dynamicritchtexteditor")
								}
							}
						}
					}
